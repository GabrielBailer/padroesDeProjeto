...
public class CarroBuilder {
    ...
    public CarroBuilder addAnoModelo(int anoModelo){
        instance.setAnoModelo(anoModelo);
        return this;
    }
    ...
    public CarroBuilder addNomeMotorista(String nome){
        motorista.setNome(nome);
        return this;
    }
    public CarroBuilder addNCNHMotorista(String cnh){
        motorista.setCnh(cnh);
        return this;
    }
    public Carro build() throws Exception{
        if(instance.getPlaca()==null){
            throw new Exception("Carro sem placa!");
        }
        if(motorista.getNome()==null){
            throw new Exception("Motorista sem nome!");
        }
        if(motorista.getCnh()==null){
            throw new Exception("Motorista sem CNH!");
        }
